...
Create the repo structure and local development foundation.
...
Create useful analytical tables.
...
Goal:
Make critical table assumptions explicit and enforceable.
...
Goal:
Create ML-ready feature tables and document them properly.
...
Goal:
Train one simple forecasting model on the feature table.
